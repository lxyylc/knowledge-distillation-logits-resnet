...
class ResNet(nn.Module):
    ...
    def __init__(self,ResidualBlock,num_class=10):
        ...
        self.layer1 = self.make_layer(ResidualBlock, 16, 16, 9, stride=1)  # 不降采样
        self.layer2 = self.make_layer(ResidualBlock, 16, 32, 9, stride=2)  # 高宽减半
        self.layer3 = self.make_layer(ResidualBlock, 32, 64, 9, stride=2)  # 高宽再减半
